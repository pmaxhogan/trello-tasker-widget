/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bacd2daeb33691f2836261a386ad4514)
// Runtime types generated with workerd@1.20260701.1 2026-03-10 nodejs_compat
interface __BaseEnv_Env {
	SESSION_KV: KVNamespace;
	LIST_NAMES: ["Inbox","Ready","Today","Progress","Work"];
	LIST_NAME_TO_BUTTONS: {"Inbox":"Archive,Ready,Today,Work,Done","Ready":"Archive,Tomorrow,Today,Work,Done","Today":"Archive,Tomorrow,Ready,Work,Done","Progress":"Archive,Ready,Today,Work,Done","Work":"Archive,Ready,Today,Done"};
	ICONS: {"Rename":"android.resource://net.dinglisch.android.taskerm/drawable/mw_editor_border_color","Archive":"android.resource://net.dinglisch.android.taskerm/drawable/mw_content_archive","Tomorrow":"android.resource://net.dinglisch.android.taskerm/drawable/mw_av_skip_next","Refresh":"android.resource://net.dinglisch.android.taskerm/drawable/mw_action_cached","Ready":"android.resource://net.dinglisch.android.taskerm/drawable/mw_navigation_arrow_forward","Today":"android.resource://net.dinglisch.android.taskerm/drawable/mw_action_today","Work":"android.resource://net.dinglisch.android.taskerm/drawable/mw_action_work"};
	API_KEY: string;
	TRELLO_KEY: string;
	TRELLO_TOKEN: string;
	INBOX_SESSION_KEY: string;
	TO_BOARD: string;
	LIST_NAME_TO_ID: string;
	TIME_ESTIMATE_MAP: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LIST_NAMES" | "LIST_NAME_TO_BUTTONS" | "ICONS" | "API_KEY" | "TRELLO_KEY" | "TRELLO_TOKEN" | "INBOX_SESSION_KEY" | "TO_BOARD" | "LIST_NAME_TO_ID" | "TIME_ESTIMATE_MAP">> {}
}
